...
export default function SearchPerformers({ params }: { params: { search: string } }) {
    ...
    function GetPerformers() {
        let url = 'http://127.0.0.1:8000/api/performers/search/'+params.search+'/';
  ...
  return (
        <>
        <Center><Heading as='h1' ml='10' m={5}>{params.search} - SEARCH - PERFORMERS</Heading></Center>
            ...
            <SimpleGrid columns={[1, 1, 2, 3, 4]} spacing={10} m={5}>
            {
                perfomers?.map((performer, index) => (
                    ...
                    <Stack>
                        ...
                        <StatGroup>
                            <Stat>
                                <Container>
                                    ...
                                    <StatNumber>{performer.sum}</StatNumber>
                                </Container>
                            </Stat>
                        ...
                        <Center>
                        <CardFooter>
                        <Link href={'/perfomers/'+performer.id+'/'}>
